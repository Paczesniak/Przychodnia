...
<head>
    ...
    <title>Przychodnia - Wizyty Lekarza</title>
...
<body>
    ...
    <main>
        <section id="wizyty" class="wizyty py-5">
            <div class="container">
                <h2 class="section-title mt-2">Wizyty lekarza {{ $lekarz->imie }} {{ $lekarz->nazwisko }} w dniu {{ $date }}</h2>
                    ...
                    <table class="table table-striped text-white mt-5 mb-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $visit->pacjent }}</td>
                                <td>{{ $visit->data_wizyty }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                </div>
                <a href="{{ route('lekarze.index') }}" class="btn btn-outline-primary">Powrót</a>
            </div>
        </section>
    </main>
