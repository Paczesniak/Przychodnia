...
<body>
    <div class="info-box">
        ...
        <div class="info-item">
            <span>Imię: {{ $lekarz->imie }}</span>
        </div>
        <div class="info-item">
            <span>Nazwisko: {{ $lekarz->nazwisko }}</span>
        </div>
        <div class="info-item">
            <span>Email: {{ $lekarz->user->email }}</span>
        </div>
        <div class="info-item">
            <span>Telefon: {{ $lekarz->telefon }}</span>
        </div>
        <div class="info-item">
            <span>Liczba pacjentów: {{ $patientCount }}</span>
        </div>
        <a href="{{ route('lekarze.index') }}" class="btn">Powrót</a>
    </div>
</body>
</html>
