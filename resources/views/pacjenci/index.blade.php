...
<body>
    ...
    <main>
        <section id="pacjenci" class="pacjenci py-5">
            <div class="container">
                <h2 class="section-title mt-2">Pacjenci</h2>
                    ...
                    <table class="table table-striped text-white mt-5 mb-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $pacjent->pesel }}</td>
                                <td>{{ $pacjent->user->email }}</td>
                                <td>{{ $pacjent->telefon }}</td>
                                <td>{{ $pacjent->data_urodzenia }}</td>
                                <td>
                                    <a href="{{ route('pacjenci.edit', $pacjent->id) }}" class="btn btn-sm btn-outline-warning">Edytuj</a>
                                    <form action="{{ route('pacjenci.destroy', $pacjent->id) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-outline-danger">Usuń</button>
                                    </form>
                                    <a href="{{ route('pacjenci.show', $pacjent->id) }}" class="btn btn-sm btn-outline-primary">Informacje</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
