...
<body>
    <div class="login-box">
        ...
        <form action="{{ route('wizyty.store') }}" method="POST">
            @csrf
            <div class="user-box">
                <select name="pacjent_id" required>
                    @foreach($pacjenci as $pacjent)
                        <option value="{{ $pacjent->id }}">{{ $pacjent->imie }} {{ $pacjent->nazwisko }}</option>
                    @endforeach
                </select>
                <label>Pacjent</label>
            </div>
            ...
            <div class="user-box">
                <input type="text" name="data_wizyty" required placeholder="dd-mm-rrrr" class="date-input">
            ...
            <div class="user-box">
                <select name="choroba_id">
                    ...
                    @foreach($choroby as $choroba)
                        <option value="{{ $choroba->id }}">{{ $choroba->nazwa }}</option>
                    @endforeach
                </select>
                <label>Choroba</label>
            </div>
            <div class="user-box">
                <select name="leczenie_id">
                    ...
                    @foreach($leczenia as $leczenie)
                        <option value="{{ $leczenie->id }}">{{ $leczenie->nazwa }}</option>
                    @endforeach
                </select>
                <label>Leczenie</label>
            </div>
            <button type="submit" class="btn">Dodaj Wizytę</button>
        </form>
    </div>
