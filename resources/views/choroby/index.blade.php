...
<body>
    ...
    <main>
        <section id="choroby" class="choroby py-5">
            <div class="container">
                <h2 class="section-title mt-2">Lista Chorób</h2>
                <div class="btn mb-3">
                    <a href="{{ route('choroby.create') }}" class="btn btn-outline-primary">Dodaj Chorobę</a>
                </div>
                    ...
                    <table class="table table-striped text-white mt-5 mb-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $choroba->nazwa }}</td>
                                <td>
                                    <a href="{{ route('choroby.edit', $choroba->id) }}" class="btn btn-sm btn-outline-warning">Edytuj</a>
                                    <form action="{{ route('choroby.destroy', $choroba->id) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
